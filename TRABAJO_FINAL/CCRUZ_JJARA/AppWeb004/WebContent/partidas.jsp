...
<body>
	<div class="container">
		...
		<header>
			<!-- <h1>Registro de Propiedades <span>Bienes inmuebles y sus propietarios.</span></h1> -->

			<!--  -->
			<h1>Nueva Partida</h1>
			<form method="POST" action="PartidaController">
				<table>
					<tr>
						<td>Oficina</td>
						<td>Registro</td>
			...
			<div class="egcc-partidas">
				<div class="egcc-panel-body" id="divPart"></div>
			</div>			
		</header>
	</div>
	<!-- /container -->
