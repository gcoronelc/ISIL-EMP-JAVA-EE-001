...
public class ListadoxCategoriaView extends javax.swing.JDialog {

    private CursoController controller;
    private double TotalVenta;

    public ListadoxCategoriaView(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
  ...
  private void btnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultarActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListadoxCategoriaView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ListadoxCategoriaView dialog = new ListadoxCategoriaView(new javax.swing.JFrame(), true);
